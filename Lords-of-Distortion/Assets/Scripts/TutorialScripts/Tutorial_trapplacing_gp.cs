...
public class Tutorial_trapplacing_gp: MonoBehaviour {
	...
	private string secondMessage = "Use the right analog and bumper to place trap";
	private string thirdMessage = "Tap bumper again to activate your trap";
    private string fourthMessage = "Traps can kill either directly or indirectly";
	private string fifthMessage = "You can still place traps after death";
